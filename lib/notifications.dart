...
class ScheduleNotifications {
  static const MethodChannel _channel = MethodChannel('schedule_notifications');
  ...
  static Future<dynamic> schedule(String text, DateTime when, List<int> repeatAt) {
    return _channel.invokeMethod('scheduleNotification', [
      text,
      when.toString(),
      repeatAt
    ]);
  ...
  static Future<dynamic> setNotificationIcon(int icon) {
    return _channel.invokeMethod('setNotificationIcon', [
      icon
    ]);
  }
